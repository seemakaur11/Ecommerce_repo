                            ...
                            SliderList.map((obj) => {
                                ...
                                return (
                                    <div className='row pt-5' key={id}>
                                        <div className='col-md-2 tempText'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-9'>
                            <div className='row pt-5 '>
                                <div className='col-lg-2 m-auto cardImg'>
                                ...
                                <div className='col-lg-2 m-auto cardImg'>
                                    <img src={lam_icon3} className="lamImg" alt="lam_icon3" />
                                    <h6 className='pt-3 cardTitle'>Engineered Flooring</h6>
                                </div>
                                <div className='col-lg-2 m-auto cardImg11'>
                                    <img src={lam_icon4} className="lamImg" alt="lam_icon4" />
                                    <h6 className='cardTitle py-2'>Solid Timber and Parquetry Flooring</h6>
                                </div>
                            </div>
                        </div>
                    </div>
